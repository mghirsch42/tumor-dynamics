...
def update_results(curr_results, exp, params, opt_results):
    ...
    curr_results["est_intrST"].append(opt_results.x[2])
    curr_results["est_intrTR"].append(opt_results.x[3])
    curr_results["est_intrTS"].append(opt_results.x[4])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--t_intr_pure_file", action="store", default="results/interaction_results/t_interaction_pure.csv")
    parser.add_argument("--t_init_file", action="store", default="data/t_cell_starting_sizes.csv")
    parser.add_argument("--save_file", action="store", default="results/interaction_results/t_interaction.csv")

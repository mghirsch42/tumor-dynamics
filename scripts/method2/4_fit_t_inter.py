...
if __name__ == "__main__":
    ...
    parser.add_argument("--clone_intr_file", action="store", default="results/interaction_results/without_growT/clone_interaction.csv")
    parser.add_argument("--t_intr_pure_file", action="store", default="results/interaction_results/without_growT/t_interaction_pure.csv")
    parser.add_argument("--t_init_file", action="store", default="data/t_cell_starting_sizes.csv")
    parser.add_argument("--save_file", action="store", default="results/interaction_results/without_growT/t_interaction.csv")

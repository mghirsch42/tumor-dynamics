...
def update_results(curr_results, exp, params, opt_results):
    ...
    curr_results["avg_growS"].append(params["avg_growR"])
...
def main(exp_file, growth_rate_file, save_file):
    ...
    for idx, row in df.iterrows():
        ...
        grow_vals = {"avg_growR": params["avg_growR"], "avg_growR": params["avg_growR"]}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--growth_rate_file", action="store", default="results/interaction_results/clone_growth_rates.csv")
    parser.add_argument("--save_file", action="store", default="results/interaction_results/clone_interaction.csv")

    ...
    for idx, row in df.iterrows():
        ...
        if "A1" in exp:
            ...
            opt_results = dual_annealing(utils.one_step_error_t_pure,
                            x0 = [params["init_intrST"], params["init_intrTS"]],
            ...
            opt_results = dual_annealing(utils.one_step_error_t_pure,
                            x0 = [params["init_intrRT"], params["init_intrTR"]],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_file", action="store", default="results/method3/t_interaction_pure.csv")

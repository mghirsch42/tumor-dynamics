...
df = pd.read_csv("results/method3/t_interaction.csv")
rs_df = pd.read_csv("results/method3/clone_interaction.csv")
...
rt_df = df[["exp", "id", "est_intrRT", "est_intrTR", "obj_func_val"]]
st_df = df[["exp", "id", "est_intrST", "est_intrTS", "obj_func_val"]]
...
def plot_sep_by_exp(df, var_x, var_y, title, save_file, save, show):
    ...
    for i in range(len(exps)):
        ...
        # sns.scatterplot(data=exp_data, x=var_x, y=var_y, ax=axes[i], hue="id", palette=colormaps["tab10"])
...
# plot_sep_by_exp(rt_df, "est_intrRT", "est_intrTR", title_prefix+"\nR vs T", save_path+"r_vs_t/ind.png", save, show)
# plot_sep_by_exp(rt_df_avg, "est_intrRT", "est_intrTR", title_prefix+"\nR vs T", save_path+"r_vs_t/ind_avg.png", save, show)
# plot_sep_by_exp(st_df, "est_intrST", "est_intrTS", title_prefix+"\nS vs T", save_path+"s_vs_t/ind.png", save, show)
# plot_sep_by_exp(st_df_avg, "est_intrST", "est_intrTS", title_prefix+"\nS vs T", save_path+"s_vs_t/ind_avg.png", save, show)
...
# plot_all_on_one(rt_df, "est_intrRT", "est_intrTR", title_prefix+"\nR vs T", save_path+"r_vs_t/all.png", save, show)
# plot_all_on_one(rt_df_avg, "est_intrRT", "est_intrTR", title_prefix+"\nR vs T", save_path+"r_vs_t/all_avg.png", save, show)
# plot_all_on_one(st_df, "est_intrST", "est_intrTS", title_prefix+"\nS vs T", save_path+"s_vs_t/all.png", save, show)
# plot_all_on_one(st_df_avg, "est_intrST", "est_intrTS", title_prefix+"\nS vs T", save_path+"s_vs_t/all_avg.png", save, show)

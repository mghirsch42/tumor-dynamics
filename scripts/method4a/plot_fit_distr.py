...
t_intr_pure_df = pd.read_csv("results/method4a/t_interaction_pure.csv")
t_intr_admix_df = pd.read_csv("results/method4a/t_interaction.csv")
...
plot_fit_vs_value_all(t_intr_admix_df, "est_intrTV", title_prefix+"\nEffect of tumor on T vs Objective Functions", save_path+"obj_func/intrTV_vs_obj_func_all.png", save, show)
...
plot_fit_vs_value_by_exp(t_intr_admix_df, "est_intrTV", title_prefix+"\nEffect of tumor on T vs Objective Functions", save_path+"obj_func/intrTV_vs_obj_func_ind.png", save, show)

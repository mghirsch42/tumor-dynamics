...
if __name__ == "__main__":
    ...
    parser.add_argument("--growth_rate_file", action="store", default="results/method4a/clone_growth_rates.csv")
    parser.add_argument("--save_file", action="store", default="results/method4a/clone_interaction.csv")
